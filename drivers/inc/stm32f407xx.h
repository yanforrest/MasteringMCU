 ...
 * e.g : Number of Registers of SPI periperal of STM32F4x family of MCUS may be differ
 * compared to number of registers of SPI peripheral of STM32Lx or STM32F0x famliy of MCU
 ...
 */
 ...
 typedef struct
 {
 	 ...
 	 __vo uint32_t LCKR;    
 	 __vo uint32_t AFR[2];    
 } GPIO_RegDef_t;                   /*!< AFR[0]: GPIO alternate function low
 
 /*
  * peripheral registre definition structure for RCC
  */
typedef struct
{
   ...
   __vo uint32_t BDCR; 
	 ...
	 __vo uint32_t SSCGR;             /*!< GPIO port mode register, */
...
#define I2C1           ((SPI_RegDef_t *)I2C1_BASEADDR)
#define I2C2           ((SPI_RegDef_t *)I2C2_BASEADDR)
#define I2C3           ((SPI_RegDef_t *)I2C3_BASEADDR)
...
/*
 * Clock Enable Macros for I2Cx periphberals
 */
...
/*
 * Clock Enable Macros for SPIx periphberals
 */
...
/*
 * Clock Enable Macros for USARTx periphberals
 */
...
/*
 * Clock Enable Macros for SYSCFG periphberal
 */
#define SYSCFG_PCLK_EN() (RCC->APB2ENR |= (1 << 14))
 
/*
 * Clock Disable Macros for GPIOx periphberals
 */
...
/*
 * Clock Disable Macros for SPIx periphberals
 */
...
/*
 * Clock Disable Macros for USARTx periphberals
 */
...
/*
 * IRQ (Interrrupt Request) Numbers of StM32F407x MCU
 * Note: update these macros with vaild values according to your MCU
